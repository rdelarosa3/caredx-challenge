// This API is compiled separately from the core runtime, so we can't directly import APIs from v2.
// Instead, use the skuid object supplied by the registerApi wrapper function. See CORE-2043
/* global skuid */
...
//----------------------------------------------------------
/**
 * Register Highcharts as a v2 API
 * @author Skuid
 */
window.skuid.runtime.registerApi("v2", "lib/highmaps", function(skuid){
    let Highcharts = skuid.lib.Highcharts;
//----------------------------------------------------------
